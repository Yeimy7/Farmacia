...
class Producto
{
    ...
    function editar($id, $nombre, $concentracion, $adicional, $precio, $laboratorio, $tipo, $presentacion)
    {
        ...
        if (!empty($this->objetos)) {
            ...
            $sql = "UPDATE producto SET nombre=:nombre , concentracion=:concentracion , adicional=:adicional ,precio=:precio, prod_lab=:laboratorio , prod_tip_prod=:tipo , prod_present=:presentacion where id_producto=:id;";
            $query = $this->acceso->prepare($sql);
